        ...
        [ Ui.column
            ...
            [ Theme.rowToColumnWhen 700
                ...
                [ Ui.image [ Ui.width (Ui.px 300) ]
                    ...
                    , description = "A watercolor drawing of Colehayes Park"
                    , onLoad = Nothing
                    }
...
content =
    ...
    , Section "Our sponsors"
        [ Images
            [ [ { source = "/sponsors/vendr.png", link = Just "https://www.vendr.com/", maxWidth = Just 350, description = "Vendr's logo" }
              ]
            , [ { source = "/sponsors/ambue-logo.png", link = Just "https://www.ambue.com/", maxWidth = Just 220, description = "Ambue's logo" }
              , { source = "/sponsors/nlx-logo.svg", link = Just "https://nlx.ai", maxWidth = Just 110, description = "NLX's logo" }
              ]
            , [ { source = "/sponsors/concentrichealthlogo.svg", link = Just "https://concentric.health/", maxWidth = Just 200, description = "Concentric health's logo" }
              , { source = "/sponsors/logo-dividat.svg", link = Just "https://dividat.com", maxWidth = Just 160, description = "Dividat's logo" }
              ]
