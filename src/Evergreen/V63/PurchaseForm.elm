module Evergreen.V63.PurchaseForm exposing (..)
...
type alias PurchaseForm =
    ...
    , country : String
    , originCity : String
    , primaryModeOfTravel : Maybe Evergreen.V63.TravelMode.TravelMode
...
type alias SinglePurchaseData =
    { attendeeName : Evergreen.V63.Name.Name
    , billingEmail : Evergreen.V63.EmailAddress.EmailAddress
    , country : String.Nonempty.NonemptyString
    , originCity : String.Nonempty.NonemptyString
    , primaryModeOfTravel : Evergreen.V63.TravelMode.TravelMode
...
type alias CouplePurchaseData =
    { attendee1Name : Evergreen.V63.Name.Name
    , attendee2Name : Evergreen.V63.Name.Name
    , billingEmail : Evergreen.V63.EmailAddress.EmailAddress
    , country : String.Nonempty.NonemptyString
    , originCity : String.Nonempty.NonemptyString
    , primaryModeOfTravel : Evergreen.V63.TravelMode.TravelMode
