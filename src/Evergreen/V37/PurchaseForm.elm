module Evergreen.V37.PurchaseForm exposing (..)
...
type alias PurchaseForm =
    ...
    , country : String
    , originCity : String
    , primaryModeOfTravel : Maybe Evergreen.V37.TravelMode.TravelMode
...
type alias SinglePurchaseData =
    { attendeeName : Evergreen.V37.Name.Name
    , billingEmail : Evergreen.V37.EmailAddress.EmailAddress
    , country : String.Nonempty.NonemptyString
    , originCity : String.Nonempty.NonemptyString
    , primaryModeOfTravel : Evergreen.V37.TravelMode.TravelMode
...
type alias CouplePurchaseData =
    { attendee1Name : Evergreen.V37.Name.Name
    , attendee2Name : Evergreen.V37.Name.Name
    , billingEmail : Evergreen.V37.EmailAddress.EmailAddress
    , country : String.Nonempty.NonemptyString
    , originCity : String.Nonempty.NonemptyString
    , primaryModeOfTravel : Evergreen.V37.TravelMode.TravelMode
