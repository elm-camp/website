module Evergreen.V48.PurchaseForm exposing (..)
...
type alias PurchaseForm =
    ...
    , country : String
    , originCity : String
    , primaryModeOfTravel : Maybe Evergreen.V48.TravelMode.TravelMode
...
type alias SinglePurchaseData =
    { attendeeName : Evergreen.V48.Name.Name
    ...
    , primaryModeOfTravel : Evergreen.V48.TravelMode.TravelMode
...
type alias CouplePurchaseData =
    { attendee1Name : Evergreen.V48.Name.Name
    , attendee2Name : Evergreen.V48.Name.Name
    , billingEmail : Evergreen.V48.EmailAddress.EmailAddress
    , country : String.Nonempty.NonemptyString
    , originCity : String.Nonempty.NonemptyString
    , primaryModeOfTravel : Evergreen.V48.TravelMode.TravelMode
