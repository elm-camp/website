module Evergreen.V22.PurchaseForm exposing (..)
...
type alias PurchaseForm =
    ...
    , country : String
    , originCity : String
    , primaryModeOfTravel : Maybe Evergreen.V22.TravelMode.TravelMode
...
type alias SinglePurchaseData =
    { attendeeName : Evergreen.V22.Name.Name
    , billingEmail : Evergreen.V22.EmailAddress.EmailAddress
    , country : String.Nonempty.NonemptyString
    , originCity : String.Nonempty.NonemptyString
    , primaryModeOfTravel : Evergreen.V22.TravelMode.TravelMode
...
type alias CouplePurchaseData =
    { attendee1Name : Evergreen.V22.Name.Name
    , attendee2Name : Evergreen.V22.Name.Name
    , billingEmail : Evergreen.V22.EmailAddress.EmailAddress
    , country : String.Nonempty.NonemptyString
    , originCity : String.Nonempty.NonemptyString
    , primaryModeOfTravel : Evergreen.V22.TravelMode.TravelMode
