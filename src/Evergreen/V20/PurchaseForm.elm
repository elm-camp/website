module Evergreen.V20.PurchaseForm exposing (..)

import Evergreen.V20.EmailAddress
import Evergreen.V20.Name
import Evergreen.V20.TravelMode
...
type alias PurchaseForm =
    ...
    , country : String
    , originCity : String
    , primaryModeOfTravel : Maybe Evergreen.V20.TravelMode.TravelMode
...
type alias SinglePurchaseData =
    { attendeeName : Evergreen.V20.Name.Name
    ...
    , primaryModeOfTravel : Evergreen.V20.TravelMode.TravelMode
...
type alias CouplePurchaseData =
    { attendee1Name : Evergreen.V20.Name.Name
    , attendee2Name : Evergreen.V20.Name.Name
    , billingEmail : Evergreen.V20.EmailAddress.EmailAddress
    , country : String.Nonempty.NonemptyString
    , originCity : String.Nonempty.NonemptyString
    , primaryModeOfTravel : Evergreen.V20.TravelMode.TravelMode
