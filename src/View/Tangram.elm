...
viewWithClickHandlers : Tangram -> (PieceId -> msg) -> Maybe PieceId -> Svg msg
viewWithClickHandlers tangram onPieceClick selectedPiece =
    let
        isSelected pieceId =
            selectedPiece == Just pieceId

        renderPiece pieceId renderFunc config =
            g
                [ Html.Events.onClick (onPieceClick pieceId)
                , Svg.Attributes.cursor "pointer"
                , if isSelected pieceId then
                    Svg.Attributes.class "selected"

                  else
                    Svg.Attributes.class ""
                ]
                [ renderFunc config tangram.scale
                , if isSelected pieceId then
                    -- Add highlight stroke for selected piece
                    g []
                        [ case pieceId of
                            FirstLargeTriangle ->
                                polygon
                                    ...
                                    , stroke "#00aaff"
                                    , strokeWidth "6"
                                    , transform (transformValue_ config "150 75" tangram.scale)
                            ...
                            MediumTriangle ->
                                polygon
                                    ...
                                    , stroke "#00aaff"
                                    , strokeWidth "6"
                                    , transform (transformValue_ config "106.08 53.04" tangram.scale)
                                    , Svg.Attributes.pointerEvents "none"
                                    ]
                                    []
                            ...
                            FirstSmallTriangle ->
                                polygon
                                    ...
                                    , stroke "#00aaff"
                                    , strokeWidth "6"
                                    , transform (transformValue_ config "75 37.5" tangram.scale)
                                    , Svg.Attributes.pointerEvents "none"
                                    ]
                                    []
                            ...
                            Square ->
                                polygon
                                    ...
                                    , stroke "#00aaff"
                                    , strokeWidth "6"
                                    , transform (transformValue_ config "53.04 53.04" tangram.scale)
                                    , Svg.Attributes.pointerEvents "none"
                                    ]
                                    []
    ...
    svg
        ...
        [ renderPiece FirstLargeTriangle largeTriangle tangram.firstLargeTriangle
        , renderPiece SecondLargeTriangle largeTriangle tangram.secondLargeTriangle
        , renderPiece FirstSmallTriangle smallTriangle tangram.firstSmallTriangle
        , renderPiece SecondSmallTriangle smallTriangle tangram.secondSmallTriangle
        , renderPiece MediumTriangle mediumTriangle tangram.mediumTriangle
        , renderPiece Square square tangram.square
        , renderPiece Parallelogram parallelogram tangram.parallelogram
        ]
