module Fusion.Generated.Money exposing
    ( build_Currency, patch_Currency, patcher_Currency, query_Currency, toValue_Currency
    )

{-|
@docs build_Currency, patch_Currency, patcher_Currency, query_Currency, toValue_Currency
-}
...
query_Currency : Fusion.Query -> Money.Currency -> Fusion.Value
query_Currency query value =
    case query of
        Fusion.QLoad ->
            Result.Ok
                (case value of
